...
const OauthVkLoginButton: FC<OauthVkLoginButtonProps> = ({}) => (
  <div
    className={clsx(
      ...
      styles.VkIdWebSdk__button_container,
    )}
  >
    ...
    <div className={styles.VkIdWebSdk__button_text}>Войти через VK ID</div>
  </div>
);

export default OauthVkLoginButton;
export { OauthVkLoginButton };
